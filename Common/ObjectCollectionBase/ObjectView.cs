...
namespace SystemFramework.Common.ObjectCollectionBase
{
    ...
    public class ObjectView<T> : INotifyingEditableObject, IDataErrorInfo, INotifyPropertyChanged, ICustomTypeDescriptor
    {
        ...
        public ObjectView(T @object, AggregateObjectColletionView<T> parent)
        {
            _parent = parent;
        ...
        /// </summary>
        private AggregateObjectColletionView<T> _parent;
        /// <summary>
        ...
        public T Object
        {
            ...
            private set
            {
                if (value == null)
                {
                   throw new ArgumentNullException("Object", SystemFramework.Properties.Resources.ObjectCannotBeNull);
                }
                _object = value;
            }
        }
