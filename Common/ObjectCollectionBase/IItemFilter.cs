...
namespace SystemFramework.Common.ObjectCollectionBase
{
    ...
    public class IncludeAllItemFilter<T> : IItemFilter<T>
    {
        ...
        {
           return SystemFramework.Properties.Resources.NoFilter;
        }
    ...
    public class PredicateItemFilter<T> : IItemFilter<T>
    {
        ...
        public PredicateItemFilter(Predicate<T> includeDelegate, string name)
        {
            ...
            {
                throw new ArgumentNullException("includeDelegate", SystemFramework.Properties.Resources.IncludeDelegateCannotBeNull);
            }
        }

        private Predicate<T> _includeDelegate;
        private string _name;
        private readonly string defaultName = SystemFramework.Properties.Resources.PredicateFilter;
