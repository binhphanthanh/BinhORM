...
{
    public class AggregateObjectColletionView<T> : Component, IBindingListView, IList, IRaiseItemChangedEvents, ICancelAddNew, ITypedList
    {
        #region Constructors

        public AggregateObjectColletionView()
        {
        ...
        public AggregateObjectColletionView(IContainer container)
            : this()
        {
            container.Add(this);
        ...
        public IList SourceLists
        {
            ...
            set
            {
                if (value == null)
                {
                   throw new ArgumentNullException("SourceLists", SystemFramework.Properties.Resources.SourceListsNull);
                }
                ...
                foreach (object obj in value)
                {
                    ...
                    foreach (object item in list)
                    {
                        if (!(item is T))
                        {
                           throw new InvalidSourceListException(string.Format(SystemFramework.Properties.Resources.InvalidListItemType, typeof(T).FullName));
                        }
                    }
                }
        ...
        protected virtual T OnAddingNew()
        {
            ...
            {
               throw new InvalidOperationException(SystemFramework.Properties.Resources.CannotAddNewItem);
            }
        }
        ...
        public IList NewItemsList
        {
            ...
            set
            {
                ...
                {
                   throw new ArgumentException(SystemFramework.Properties.Resources.SourceListNotFound);
                }
                _newItemsList = value;
            }
        }
        ...
        public void ApplyFilter(Predicate<T> includeItem)
        {
            if (includeItem == null)
            {
               throw new ArgumentNullException("includeItem", SystemFramework.Properties.Resources.IncludeDelegateCannotBeNull);
            }

            Filter = AggregateObjectColletionView<T>.CreateItemFilter(includeItem);
        }
        ...
        */
        ...
        public int Find(string propertyName, object key)
        {
            ...
            {
               throw new ArgumentException(string.Format(SystemFramework.Properties.Resources.PropertyNotFound, propertyName, typeof(T).FullName), "propertyName");
            }
        }
        ...
        int IList.Add(object value)
        {
            ...
            throw new NotSupportedException(SystemFramework.Properties.Resources.CannotAddItem);
        }
        ...
        void IList.Clear()
        {
           throw new NotSupportedException(SystemFramework.Properties.Resources.CannotClearView);
        }
        ...
        {
           throw new NotSupportedException(SystemFramework.Properties.Resources.CannotInsertItem);
        }
        ...
        object IList.this[int index]
        {
            ...
            set
            {
                ...
                // in this manner.
               throw new NotSupportedException(SystemFramework.Properties.Resources.CannotSetItem);
            }
        }
        ...
        {
           get { throw new NotSupportedException(SystemFramework.Properties.Resources.SyncAccessNotSupported); }
        }
        ...
        {
            Type viewTypeDef = typeof(ObjectCollectionView<object>).GetGenericTypeDefinition();
